...
const addCharacterGet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const editCharacterGet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (!errors.isEmpty()) {
        ...
        try {
          const currentCharacter = yield characterModel_1.default
            .findById(req.params.id)
            .orFail(new Error('Character not found.'));
          if (currentCharacter) {
...
const deleteCharacterGet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteCharacterPost = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
