...
const indexGet = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const charactersByWeapon = allweapons.map((weapon) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const charactersByVision = allVisions.map((vision) => __awaiter(void 0, void 0, void 0, function* () {
