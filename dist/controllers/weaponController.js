...
exports.deleteWeaponPost =
  ...
  exports.singleWeaponCharactersGet =
...
const allWeaponsGet = (req, res, next) =>
...
const singleWeaponCharactersGet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const editWeaponGet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (!errors.isEmpty()) {
        ...
        try {
          const currentWeapon = yield weaponModel_1.default
            .findById(req.params.id)
            .orFail(new Error('Weapon not found.'));
...
const deleteWeaponGet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteWeaponPost = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const weapon = yield weaponModel_1.default.findById(req.params.id).exec();
      const characters = yield characterModel_1.default.find({ weapon: req.params.id }).exec();
